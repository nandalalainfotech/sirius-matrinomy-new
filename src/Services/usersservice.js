...
export const update = async (req, res,err) => {
    ...
    if (person001mb) {
        ...
        person001mb.personalid = req.body.person001mb.personalid ? req.body.person001mb.personalid : person001mb.personalid;
        person001mb.subcatcode = req.body.person001mb.subcatcode ? req.body.person001mb.subcatcode : person001mb.subcatcode;
        person001mb.professionalid = req.body.person001mb.professionalid ? req.body.person001mb.professionalid : person001mb.professionalid;
        person001mb.categoryid = req.body.person001mb.categoryid ? req.body.person001mb.categoryid : person001mb.categoryid;
        person001mb.languageid = req.body.person001mb.languageid ? req.body.person001mb.languageid : person001mb.languageid;
        person001mb.religionid = req.body.person001mb.religionid ? req.body.person001mb.religionid : person001mb.religionid;
        person001mb.classificationid = req.body.person001mb.classificationid ? req.body.person001mb.classificationid : person001mb.classificationid;
        person001mb.subscsubspid = req.body.person001mb.subscsubspid ? req.body.person001mb.subscsubspid : person001mb.subscsubspid;
        person001mb.regionalid = req.body.person001mb.regionalid ? req.body.person001mb.regionalid : person001mb.regionalid;
        person001mb.companycode = req.body.person001mb.companycode ? req.body.person001mb.companycode : person001mb.companycode;
        person001mb.cityid = req.body.person001mb.cityid ? req.body.person001mb.cityid : person001mb.cityid;
        person001mb.stateid = req.body.person001mb.stateid ? req.body.person001mb.stateid : person001mb.stateid;
        person001mb.roleid = req.body.person001mb.roleid ? req.body.person001mb.roleid : person001mb.roleid;
        ...
        person001mb.countryid = req.body.person001mb.countryid ? req.body.person001mb.countryid : person001mb.countryid;
        person001mb.address = req.body.person001mb.address ? req.body.person001mb.address : person001mb.address;
        person001mb.phoneno = req.body.person001mb.phoneno ? req.body.person001mb.phoneno : person001mb.phoneno;
        ...
        person001mb.lastname = req.body.person001mb.lastname ? req.body.person001mb.lastname : person001mb.lasttname;
        ...
        login001mb.username = req.body.login001mb.username ? req.body.login001mb.username : login001mb.username;
        login001mb.password = req.body.login001mb.password ? bcrypt.hashSync(req.body.login001mb.password, 10) : login001mb.password;
        ...
        users001wb.employeeid = req.body.user001wb.employeeid ? req.body.user001wb.employeeid : users001wb.employeeid;
        users001wb.personid = person._id ? person._id : users001wb.personid;
        users001wb.bankname = req.body.user001wb.bankname ? req.body.user001wb.bankname : users001wb.bankname;
        users001wb.accountnumber = req.body.user001wb.accountnumber ? req.body.user001wb.accountnumber : users001wb.accountnumber;
